...
<tr>
                                                            ...
                                                            <td data-label="Price" class="ec-cart-pro-price"><span
                                                                ...
                                                                '</span></td>
                                                            <td class="ec-cart-pro-qty"
                                                                style="text-align: center;">
                                                                <div class="cart-qty-plus-minus">
                                                                    <button data-cart="' .
                                                                $key .
                                                                '" type="button" class="ec_qty_btn">-</button>
                                                                    <input class="cart-plus-minus" type="number"
                                                                        name="cartqtybutton" value="' .
                                                                $item['quantity'] .
                                                                '" />
                                                                    <button data-cart="' .
                                                                $key .
                                                            ...
                                                            <td data-label="Remove" class="ec-cart-pro-remove">
                                                                ...
                                                                $key .
                                                                '" class="remove-cart-item"><i class="ecicon eci-trash-o"></i></button>
                                                            </td>
                                                        </tr>
';
                                                        }
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="ec-cart-update-bottom">
                                                ...
                                                <a href="{{ route('checkout') }}" class="btn btn-primary" style="text-decoration: none"><button type="button" class="text-light">Check Out</button></a>
                                            </div>
                                        </div>
                                    </div>
                                </form>
                                ...
                                <div class="ec-cart-summary-bottom">
                                    <div class="ec-cart-summary">
                                        <div>
                                            ...
                                            <span
                                                class="text-right ec-cart-total">${{ Session()->has('cart') ? number_format($total) : 0 }}</span>
                                        </div>
                                        {{-- <div>
                                        ...
                                        <div>
                                            ...
                                            <span class="text-right"><a class="ec-cart-coupan">
                                                    Áp dụng phiếu giảm giá</a></span>
                                        </div>
                                        ...
                                        <div class="ec-cart-summary-total">
                                            <span class="text-left">Tổng cộng</span>
                                            <span
                                                class="text-right ec-cart-total">${{ Session()->has('cart') ? number_format($total) : 0 }}</span>
                                        </div>
                                    </div>
